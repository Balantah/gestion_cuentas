    ...
    do {
        ...
        switch (opcion) {
            case 1: {
                ...
                Cuenta nuevaCuenta(numeroCuenta, nombreCompleto, saldoInicial);
                banco.getCuentas().push_back(nuevaCuenta); // Agregar la cuenta al banco
            ...
            case 2: {
                ...
                for (Cuenta cuenta : cuentas) { // Sin const
